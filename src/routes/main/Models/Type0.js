 ...
 *
 */
String.prototype.trimQuotes = function (this) {return this.trim().replaceAll('"', '');};

/**
 * @template A
 * @function
 * @param {A[]} array1 - arr1
 * @param {A[]} array2 - arr2 to compare
 * @returns {boolean}
 */
let flatArrEq = (array1, array2) => array1.length === array2.length && array1.every((value, index) => value === array2[index]);
